...
def main():
	...
	## Calculate shannons entropy for each kmer in unique_kmers
	entropy_dict = {}
	for kmer in unique_kmers:
		entropy_dict[kmer] = shannons_entropy(kmer)
