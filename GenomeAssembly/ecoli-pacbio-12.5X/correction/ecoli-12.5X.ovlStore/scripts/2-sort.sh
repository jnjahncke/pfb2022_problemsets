...
#  This script should be executed from correction/ecoli-12.5X.ovlStore.BUILDING/, but the binary needs
...
if [ -e ./ecoli-12.5X.ovlStore.BUILDING/$jobname.info -a ! -e ./ecoli-12.5X.ovlStore.BUILDING/$jobname.started ] ; then
  echo "Sorting job finished; info file './ecoli-12.5X.ovlStore.BUILDING/$jobname.info' exists."
  exit
fi
#
#  Sort!
