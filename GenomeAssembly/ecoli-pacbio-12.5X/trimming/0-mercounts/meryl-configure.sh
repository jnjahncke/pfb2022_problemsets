...
/Users/student/pfb2022_problemsets/GenomeAssembly/canu-2.2/bin/meryl -C k=22 threads=4 memory=2 \
  count segment=1/01 ../../ecoli-12.5X.seqStore \
> ecoli-12.5X.ms22.config.01.out 2>&1
exit 0
